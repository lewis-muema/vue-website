<template>
    <div class="estimations-holder-2 bg-blue" >
            ...
            <div class="display-dist" v-if="Array.isArray(price_request_response) && loading == false">
                ...
                <router-link to="/getstarted" target="_blank"><div class="get-started-button bg-orange bc-orange centerY centerX flex sans-pro color-white" type="button">GET STARTED</div></router-link> 
                </div>
            </div>
...
axios.post('https://api.sendyit.com/parcel/index.php/api/v11/pricing_multiple', (payload))
