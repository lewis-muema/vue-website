<template>
    <div>
        <div class ='section section__upper flex centerY'>
            ...
            <router-link v-if="windowWidth > '768'" to="/login" class='link upper__link'>
            LOG IN</router-link>
            ...
            <tr><td class="dropdown-upper-rows"><router-link to="/login" class="color-white">LOG IN</router-link></td></tr>
