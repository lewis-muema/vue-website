<template>
  <div class="careers-page">
    ...
    <div class="step-up">
      ...
      <p class="step-up-par">
        Build world class technology in Kenya.<br />
    ...
    <div
      class="jobs bg-orange"
      :style="{
        width: sectionWidth + '%',
        paddingLeft: sectionMargin + '%',
        paddingRight: sectionMargin + '%',
      }"
    >
  ...
  data() {
    return {
      ...
      jobs: [
        ...
        {
          position: 'Country General Manager',
          location: 'Uganda',
        ...
        {
          position: 'Customer & Partner Support - Country Lead',
          location: 'Uganda',
          department: 'Support',
