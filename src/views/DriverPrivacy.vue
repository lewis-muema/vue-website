    ...
    <div class="job-desc" :style="{ marginLeft: newLeft + '%', marginRight: newLeft + '%' }">
      ...
      <Ol type="1" class="job-desc-par">
        ...
        <ul class="job-desc-par">
          ...
          <li class="jobs-listing">
            Data regarding the criminal convictions and offenses is processed for compliance with a legal obligation
          </li>
        </ul>
        ...
        <ul class="job-desc-par">
          ...
          <li class="jobs-listing">
            You must comply with the rules and conditions for processing of personal data of passengers as set forth in the Privacy Notice for Sendy users
            <router-link to="/privacy">(https://sendyit.com/privacy)</router-link>. If you violate the requirements for the processing of personal data of passengers, we may terminate your drivers account and claim damages from you.
          </li>
        </ul>
        <li class="jobs-listing light-bold">
        ...
        <ul class="job-desc-par">
          ...
          <li class="jobs-listing">
            We respond to the request for deleting and transferring personal data submitted by an e-mail to
            <a href="mailto:support@sendy.co.ke">support@sendy.co.ke</a> where you may specify the period of data deletion and transfer.
          </li>
        </ul>
        ...
        <ul class="job-desc-par">
          <li class="jobs-listing">
            ...
            <a href="mailto:support@sendy.co.ke">(support@sendy.co.ke)</a>
          </li>
        </ul>
      </Ol>
    </div>
