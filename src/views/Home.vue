  ...
  <div>
      ...
      <div class="partner-col grid">
        <div class="partner-row flex centerY">
          <table class="partner-details" :style="{ position: 'absolute', left: newLeft3 + '%' }">
            ...
            <tr>
              <td>
                <button class="become-partner-button bg-orange flex centerX bottomY relative open-sans color-white bc-white" v-if="windowWidth > '768'" type="button">
                  <router-link
                    to="/partners"
                    class="color-white"
                    @click="
                      mixTrackElements('Drive With Sendy');
                      send_ga_event('Drive with Sendy Top of the page - landing page - website');
                    "
    ...
    <div class="qualities-section overflow">
      <div class="qualities-row tab1 grid">
        <div class="qualities-column-7 img-kid"></div>
      ...
      <div class="qualities-row tab1 grid">
        <div class="qualities-column-7 img-supply"></div>
        <div class="qualities-column-5 qualities-tab bg-blue flex centerX centerY">
          <div class="qualities-text-container">
...
export default {
  ...
  methods: {
    handleResize() {
      ...
      const quotient2 = (range * 30) / 1194;
      const estWidth = 50 + quotient2;
