<template>
  <div class="businesses-section">
    <p class="biz-header center-text open-sans">
      Over 50k+ users and 3k+ businesses trust Sendy
    </p>
    ...
    <router-link to="/getstarted" v-if="windowWidth > '768'"
      ><div
        class="get-started-button-bottom bg-orange bc-orange open-sans color-white center-block flex centerX centerY"
        type="button"
        @click="
          mixTrackElements('Get Started Footer');
          send_ga_event('Get started Bottom of the page - landing page - website');
        "
      >
        GET STARTED
      </div></router-link
  ...
  data() {
    return {
      imgs1: [
        {
          name: 'safaricom',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-14.png?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
        {
          name: 'multichoice',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-01.png?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
        {
          name: 'kenafric',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-02.jpg?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
        {
          name: 'haltons',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-03.png?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
        {
          name: 'bidco',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-04.jpg?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
      ],
      imgs2: [
        {
          name: 'goodlife',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-10.png?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
        {
          name: 'toyota',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-07.jpg?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
        {
          name: 'envirofit',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-06.png?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
        {
          name: 'm-kopa',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-11.png?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
        {
          name: 'doshi',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-08.png?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
      ],
      imgs3: [
        {
        ...
        },
        {
          ...
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-09.png?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
        {
          name: 'crown',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-05.jpg?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
        {
          name: 'highlands',
          url: 'https://images.sendyit.com/website/partnerbrands/PartnerBrands-12.png?v=1LeOeCUTAAAAAGs99manIwc7kghOUdgkr_rnuoCE16',
        },
      ],
      state: true,
